            ...
            modelBuilder.Entity("SmartPacking.Infrastructure.GarmentRecognitionEventEntity", b =>
                {
                    ...
                    var __converter_OccurredAt_Garment = new ValueConverter<DateTimeOffset, long>(
                        v => v.ToUnixTimeMilliseconds(),
                        v => DateTimeOffset.FromUnixTimeMilliseconds(v));

                    b.Property<DateTimeOffset>("OccurredAt")
                        .HasConversion(__converter_OccurredAt_Garment)
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SmartPacking.Infrastructure.UserAuditEventEntity", b =>
                {
                    ...
                    var __converter_OccurredAt_User = new ValueConverter<DateTimeOffset, long>(
                        v => v.ToUnixTimeMilliseconds(),
                        v => DateTimeOffset.FromUnixTimeMilliseconds(v));

                    b.Property<DateTimeOffset>("OccurredAt")
                        .HasConversion(__converter_OccurredAt_User)
                        .HasColumnType("INTEGER");
